...
<div class="publications-additional-info">
  ...
  <div class="publications-logos">
    <a href="https://scholar.google.com/citations?user=f73__XkAAAAJ&hl=en&oi=ao" class="logo-link" target="_blank" rel="noopener noreferrer">
      <img src="{{ site.baseurl }}/assets/icons/google_logo.png" alt="Google Scholar Logo" class="logo">
    ...
    <a href="https://www.researchgate.net/profile/Qisi-Wang" class="logo-link" target="_blank" rel="noopener noreferrer">
      <img src="{{ site.baseurl }}/assets/icons/researchgate_logo.png" alt="ResearchGate Logo" class="logo">
    ...
    <a href="https://orcid.org/0000-0002-8741-7559" class="logo-link" target="_blank" rel="noopener noreferrer">
      <img src="{{ site.baseurl }}/assets/icons/orcid_logo.png" alt="ORCID Logo" class="logo">
    ...
    <a href="https://arxiv.org/a/wang_q_9.html" class="logo-link" target="_blank" rel="noopener noreferrer">
      <img src="{{ site.baseurl }}/assets/icons/arxiv_logo.png" alt="arXiv Logo" class="logo">
  ...
  <div class="publications">
    ...
    <div class="publication-preprint">
        ...
        {% if preprint.picture-path %}
            <img src="{{ site.baseurl }}/assets/publications_pictures/{{preprint.picture-path}}" alt="Welcome Image">
        {% else %}
        ...
        <div class="publication-info">
            ...
            <div class="journal">{{preprint.journal}}
              {% if preprint.pdf-path %}
                <a class = "publication-button" href="{{ site.baseurl }}/assets/{{preprint.pdf-path}}" target="_blank" rel="noopener noreferrer"> 
                PDF
                </a>
              {% endif %}
              {% if preprint.arxiv %}
    ...
    <div class="publication">
        <div class="publication-picture">
          {% if publication.picture-path %}
              <img src="{{ site.baseurl }}/assets/publications_pictures/{{publication.picture-path}}" alt="Welcome Image">
          {% else %}
              <div style="width: 176px; height: 127px; background-color:#eaeaea;"> </div>
          {% endif %}
        </div>
        <div class="publication-info">
            ...
            <div class="journal">{{publication.journal}}
              {% if publication.pdf-path %}
                <a class = "publication-button" href="{{ site.baseurl }}/assets/{{publication.pdf-path}}" target="_blank" rel="noopener noreferrer"> 
                PDF
                </a>
              {% endif %}
