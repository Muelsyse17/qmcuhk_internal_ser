...
<p style="color:white;font-size:0.1em;"></p>
</div>
    ...
    <div class="member-card">
        <div class="member-image-container hover-effect">
            <a href="{{ site.baseurl }}{{ member.url }}">
                <img src="{{ site.baseurl }}/assets/web_pictures/{{member.photo-path}}" alt="{{member.photo-path}}" style="width:100%">
                <div class="overlay">
...
<div class="coffee-button">
    <a style="color:white;" href="{{ site.baseurl }}/contact/" target="_blank">
